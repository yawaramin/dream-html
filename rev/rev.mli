...
val form :
  ...
  ?csrf:bool ->
  request ->
  [> 'a Dream.form_result | `Invalid of (string * string) list]
...
val query :
  'a Form.t -> request -> [> `Ok of 'a | `Invalid of (string * string) list]
