...
let already_setup =
  "⚠️ rev-cli integration is already set up. You can access static assets in code now."

let setup_msg =
  "✅ rev-cli integration is set  up  now.  After building your project with 'dune
